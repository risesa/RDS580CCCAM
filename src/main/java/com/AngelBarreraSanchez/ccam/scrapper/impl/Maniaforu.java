 ...
 * Get a Cline from http://maniaforu.ddns.net/index.php
 * @author Angel Barrera Sanchez
 */
public class Maniaforu implements FreeClinesScrapper {
	
	private String BASE_URL = "http://maniaforu.ddns.net/index.php";
	 ...
	 * @param default_hops
	 */
	public Maniaforu(String default_hops) {
	...
	public Set<CCCAMEntity> getLines() {
		...
		try {
			final Document doc = Jsoup.connect(BASE_URL)
					...
					.referrer("http://maniaforu.ddns.net/index.php")
					.header("Content-Type", "application/x-www-form-urlencoded")
					.post();	
			final String linesweb = doc.html();
			final String lineSearch1 = "Your Free CCcam line is <br><br> C: ";
