 ...
 * Get a Cline from http://cccam-free.com/helala0.php
 * @author Angel Barrera Sanchez
 */
public class Helala0 implements FreeClinesScrapper {
	private String BASE_URL = "http://cccam-free.com/helala0.php";
	 ...
	 * @param default_hops
	 */
	public Helala0(String default_hops) {
